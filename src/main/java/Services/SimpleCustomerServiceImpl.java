...
public class SimpleCustomerServiceImpl implements CustomerService {
    ...
    static {
        customers = asList(
                new Customer(autoIncreaseId++, "T", "t@SBTC.vn", "Da Nang"),
                new Customer(autoIncreaseId++, "Nhat", "nhat@SBTC.vn", "Quang Tri"),
                new Customer(autoIncreaseId++, "Trang", "trang@SBTC.vn", "Ha Noi"),
                new Customer(autoIncreaseId++, "Nguyen Binh Son", "son@SBTC.vn", "Sai Gon"),
                new Customer(autoIncreaseId++, "Dang Xuan Hoa", "hoa.dang@SBTC.vn", "Da Nang")
        );
    }
